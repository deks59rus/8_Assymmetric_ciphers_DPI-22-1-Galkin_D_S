...
Название лабораторной: “Протоколы шифрования часть 2” (основное и доп. п.1) - Асимметричное шифрование."

Ключи сохранены в файлах:
- client_private_key.txt
- client_public_key.txt
- server_private_key.txt
- server_public_key.txt

Пожалуйста, смотрите файлы server.log и client.log они иллюстрируют историю работы сервера и клиента.
